...
@constraint(m, Qin .<= (wind_A + wind_B + wind_C)./6)
...
savefig("PowerSold.png")
# CSV.write("results.csv",  Tables.table(hcat(Optimal_Qin,Optimal_Qout,Optimal_SOC[1:end-1],Optimal_PowerSold)), writeheader=false)
